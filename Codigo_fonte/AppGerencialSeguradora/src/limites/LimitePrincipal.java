...
public class LimitePrincipal extends JFrame
{
     ...
     */
    public void exibirChat(String user)
    {
        //Receber parametros da interfae
        this.usuario = user;
        this.departamento = LimiteVisualizacaoChats.GERENCIAL;
        
        //Setar parametros no controlador
        objCtrl.setarParamentros(usuario, LimiteVisualizacaoChats.GERENCIAL);
